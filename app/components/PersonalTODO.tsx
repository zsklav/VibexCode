...
const PersonalTODO = () => {
  ...
  if (loading) {
    return (
      <div className="w-full vibe-card p-6 flex items-center justify-center h-64">
  ...
  if (error) {
    return (
      <div className="w-full vibe-card p-6">
        <div className="text-center">
  ...
  return (
    <div className="w-full vibe-card p-6 flex flex-col h-full">
      {/* Header */}
      <div className="mb-6">
